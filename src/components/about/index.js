        ...
        <div className="about-text text-justify flex flex-wrap flex-row justify-evenly content-center gap-4">
          <div className="w-2/5">
            <p>
              ...
              yardımcı olmayı amaçladık ve birçok markaya ev sahipliği yaparak
              müşterilerimizin alım gücünü güçlendirdik. 41 yıllık deneyimimizle
              işimizi temiz ve güvenilir bir şekilde ilerletmek için çabaladık.
              Müşteri memnuniyeti, kalite, uygun fiyatlar ve ödeme
              kolaylıklarıyla her konuda müşterilerimize destek olmayı
              hedefledik.
            </p>
            <br />
            <p>
