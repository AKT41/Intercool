                    ...
                    >
                        ...
                        >
                            <li>
                                <a
                                    href='#'
                                    className='block py-2 pl-3 pr-4 text-gray-900 rounded transition-all duration-200 nav-item bg-opacity-70 md:p-0 dark:text-white dark:hover:text-white dark:border-gray-700 '
                                    aria-current='page'
                                >
                            ...
                            <li className='relative'>
                                <a
                                    href='#'
                                    className='py-2 pl-3 pr-4 group peer flex md:justify-center items-center content-center gap-1 text-gray-900 rounded transition-all duration-200 nav-item bg-opacity-70 md:p-0 dark:text-white dark:hover:text-white dark:border-gray-700'
                                >
                                    <Fade top>
                                        {' '}
                                        Ürünlerimiz
