...
export default function Footer() {
  return (
    <>
      <section class="bg-gray-600  bottom-0 left-0 right-0">
          ...
          <Fade bottom>
            <nav class="flex flex-wrap justify-center -mx-5 -my-2">
              <div class="px-5 py-2">
                <a
                  href="#"
                  class="text-base leading-6 text-gray-100 hover:text-gray-100 hover:bg-slate-500 px-3 py-2 rounded-md transition-all duration-300"
                >
                  Ana Sayfa
                </a>
              </div>
